...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, branch_layers, num_classes=1000):
        self.inplanes = 64
        ...
        self.layer4_head1 = self._make_layer(block, 1024, branch_layers[1][0], stride=2)
        self.fc_head1 = nn.Linear(1024 * block.expansion, num_classes)
...
def resnet34(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [3, 4, 6, 3], [[3, 2], [3]], **kwargs)
    return model
...
def resnet50(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3], [[3, 2], [3]], **kwargs)
    return model
...
def resnet101(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 23, 3], [[12, 2], [3]], **kwargs)
    return model
...
def resnet152(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 8, 36, 3], [[18, 2], [3]], **kwargs)
    return model
